...
parser.add_argument('--cfg_dropout_prob', type=float, default=0.0,
                    help='Probability of dropping conditioning during training for CFG (0 = disabled)')
parser.add_argument('--cfg_dropout_mode', type=str, default='joint',
            ...
            if nll_val < best_nll_val:
                ...
                if args.save_model:
                    ...
                    if not args.no_wandb:
                        wandb.save('outputs/%s/*.npy' % args.exp_name, base_path='outputs/%s' % args.exp_name)
                        wandb.save('outputs/%s/*.pickle' % args.exp_name, base_path='outputs/%s' % args.exp_name)
