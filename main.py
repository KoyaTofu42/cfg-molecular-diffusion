...
def main():
    ...
    # If running in a notebook, sys.argv is filled with kernel arguments.
    # If running from Docker without extra arguments, len(sys.argv) == 1.
    if is_notebook or len(sys.argv) <= 1:
        ...
        # These same defaults will be used for both Notebooks and Docker execution
        # if no explicit arguments are passed.
        sys.argv = [
            'main.py',
            '--n_epochs', '3000',
